...
const Drawer = ({ borderColor, fillColor, size }) => {
    return (<Svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
        x="0px" y="0px"
        viewBox="0 0 502.001 502.001" style="enable-background:new 0 0 502.001 502.001;"
        width={size} height={size}
    >
        <G>
            <G>
                <G>
                    <Path style="fill:#50A5DC;" d="M445.317,133.126H56.683C30.901,133.126,10,112.225,10,86.443S30.901,39.76,56.683,39.76h388.634
               C471.099,39.76,492,60.661,492,86.443S471.099,133.126,445.317,133.126z"  fill={fillColor} />
            ...
            <G>
                <G>
                    <Path style="fill:#50A5DC;" d="M445.317,297.684H56.683C30.901,297.684,10,276.783,10,251s20.901-46.683,46.683-46.683h388.634
               C471.099,204.317,492,225.218,492,251S471.099,297.684,445.317,297.684z"  fill={fillColor} />
            ...
            <G>
                <G>
                    <Path style="fill:#50A5DC;" d="M445.317,462.24H56.683C30.901,462.24,10,441.339,10,415.557
