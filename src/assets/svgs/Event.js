...
const EventIcon = ({ size, fillColor }) => {
    return (<Svg x="0px" y="0px"
        width={size} height={size} viewBox="0 0 52 52" enable-background="new 0 0 52 52">
        <G>
       ...
       c0-0.6,0.4-1,1-1h4c0.6,0,1,0.4,1,1V32z"  fill={fillColor} />
